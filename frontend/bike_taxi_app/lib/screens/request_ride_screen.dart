      ...
      builder: (context) => ReflectionCard(
        ...
        child: Column(
          ...
          children: [
            ...
            _fareRow("Distance Computations", "₹ ${((fare - 40).clamp(0, 100000)).toStringAsFixed(2)}"),
            const Divider(height: 24),
            _fareRow("Total Invoiced Estimate", "₹ ${fare.toStringAsFixed(2)}", isTotal: true),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(fare != null ? "₹ ${fare.toStringAsFixed(0)}" : "--", style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: Colors.white)),
                ],
              ),
            ),
            GestureDetector(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Suggested Baseline: ₹ ${suggested.toStringAsFixed(0)}", style: TextStyle(color: Colors.white.withOpacity(0.45), fontSize: 13)),
                  const SizedBox(height: 20),
                  Container(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(offerAmount.toStringAsFixed(0), style: const TextStyle(color: Colors.white, fontSize: 48, fontWeight: FontWeight.w900)),
                          ],
                        ),
                      ],
                    ),
                  ...
                  ElevatedButton(
                    ...
                    child: Text("Transmit Offer Request · ₹ ${offerAmount.toStringAsFixed(0)}", style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w900)),
                  ),
                ],
              ),
            ),
