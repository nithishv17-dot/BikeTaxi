          ...
          child: NavigationBar(
            ...
            destinations: const [
              NavigationDestination(
                icon: Icon(Icons.directions_bike_rounded, color: AppPalette.slate600),
                selectedIcon: Icon(Icons.directions_bike_rounded, color: AppPalette.primary),
                label: "Home",
              ),
              NavigationDestination(
                icon: Icon(Icons.person_rounded, color: AppPalette.slate600),
    ...
    return FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError || snapshot.data == null) {
          ...
          if (session != null) {
            profile = {
              "name": session["name"]?.isNotEmpty == true ? session["name"] : "Rider",
              "phone": session["phone"]?.isNotEmpty == true ? session["phone"] : "N/A",
              "role": session["role"]?.isNotEmpty == true ? session["role"] : "user",
            };
          } else {
            profile = {
              "name": "Rider",
